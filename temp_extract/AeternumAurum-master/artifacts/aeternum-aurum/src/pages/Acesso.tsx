        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed font-light max-w-xl mx-auto">
              O acesso à plataforma Aeternum Aurum é restrito a investidores profissionais qualificados. Preencha o formulário para iniciar o processo de avaliação.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          {submitted ? (
            <FadeIn direction="none">
              <div className="border border-primary/30 p-10 text-center">
                <div className="w-10 h-10 border border-primary/40 flex items-center justify-center mx-auto mb-6">
                ...
                <p className="text-muted-foreground text-sm font-light leading-relaxed">
                  Nossa equipe irá analisar sua solicitação e entrar em contato em até 5 dias úteis. Apenas investidores qualificados serão aprovados.
                </p>
              </div>
            </FadeIn>
          ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {[
                  ...
                  <div key={field.id}>
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-card border border-white/8 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:border-primary/40 transition-colors font-sans"
                    />
                  </div>
                ))}
                ...
                <div>
                  ...
                  <textarea
                    id="mensagem"
                    rows={4}
                    placeholder="Descreva brevemente seu perfil e objetivos de investimento..."
                    className="w-full bg-card border border-white/8 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:border-primary/40 transition-colors resize-none font-sans"
                  />
                </div>

                <p className="text-[10px] text-muted-foreground/40 leading-relaxed">
                  Ao enviar, confirmo ser investidor profissional qualificado nos termos da regulamentação vigente. Esta solicitação não constitui oferta de investimento.
                </p>

                <button
                  type="submit"
                  className="w-full py-3.5 border border-primary text-primary text-[10px] tracking-[0.25em] uppercase font-sans hover:bg-primary hover:text-background transition-all duration-300"
                >
                  Enviar Solicitação
                </button>
              </form>
