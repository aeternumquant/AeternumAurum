      ...
      <FadeIn direction="none">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <NavLink
              to="/acesso"
              className="px-8 py-3 border border-primary text-primary text-[10px] tracking-[0.25em] uppercase font-sans hover:bg-primary hover:text-background transition-all duration-300"
            >
              Solicitar Acesso
            </NavLink>
            <NavLink
