...
export function WireframeCube({ className, animate = true }: WireframeCubeProps) {
  // SVG paths for an isometric wireframe cube with inner depth
  const draw = {
  ...
  return (
    ...
    >
      ...
      <svg 
        ...
        className="w-full h-full relative z-10 drop-shadow-[0_0_8px_rgba(198,167,92,0.4)]"
      >
