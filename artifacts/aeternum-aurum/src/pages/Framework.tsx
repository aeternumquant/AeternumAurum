...
export default function FrameworkPage() {
  return (
    <main className="pt-14 min-h-screen">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <FadeIn>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed font-light">
              Nossa metodologia integra análise macroeconômica, modelos quantitativos e inteligência de risco para gerar retornos consistentes e assimétricos.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      {/* Infraestrutura de Inteligência em Tempo Real */}
      <section className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-background border-b border-white/5">
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            ...
            <p className="text-center text-muted-foreground text-sm font-light max-w-2xl mx-auto mb-16">
              Agentes operam 24 horas por dia, 7 dias por semana, monitorando fluxos globais de informação relevantes para mercados macro. Cada sinal é ponderado, filtrado e convertido em posicionamento tático.
            </p>
          </FadeIn>

          {/* Visual flow */}
          <FadeIn delay={0.15}>
            <div className="border border-white/5 bg-card/30 p-8 mb-12">
              <IntelligenceFlow />
            </div>
          </FadeIn>
