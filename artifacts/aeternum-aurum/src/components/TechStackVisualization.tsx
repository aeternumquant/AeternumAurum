...
const camadas = [
  {
    ...
    nome: "MenthorQ",
    local: "Miami, FL",
    tag: "Motor Quantitativo",
    desc: "Processa 95% dos fluxos globais de derivativos para análise estrutural preditiva. Identifica exposição Net GEX e superfícies de volatilidade em todas as principais classes de ativos em tempo real.",
    badges: ["Net GEX", "Superfície de Volatilidade", "95% de Cobertura"],
  ...
  },
  {
    ...
    rotulo: "Inteligência",
    nome: "Grok Heavy AI",
    local: "Infraestrutura EUA",
    tag: "IA / Processamento de Sinais",
    desc: "Processa macro-sentimento em tempo real, filtra ruído de mercado e garante conformidade ISO 20022. Monitora continuamente sinais geopolíticos e fluxos de bancos centrais.",
    badges: ["ISO 20022", "Macro Sentimento", "Tempo Real"],
  ...
  },
  {
    ...
    rotulo: "Execução",
    nome: "Antigravity",
    local: "Corretoras EUA",
    tag: "Execução Automatizada",
    desc: "A camada de execução conectada diretamente a corretoras americanas confiáveis para hedge instantâneo e automatizado. Roteamento de ordens sub-milissegundo com trilha de auditoria completa e conformidade regulatória.",
    badges: ["Roteamento Sub-ms", "Corretoras EUA", "Trilha de Auditoria"],
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <h3 className="font-display text-2xl text-primary uppercase tracking-widest">
          Stack Tecnológico TRL 7+
        </h3>
        ...
        {camadas.map((camada, i) => (
          <div key={i} className="relative">
            ...
            <motion.div
              ...
              className={`
                relative overflow-hidden cursor-pointer border bg-gradient-to-b ${camada.color} ${camada.border}
                transition-all duration-500
                ${ativa === i ? "shadow-[0_0_40px_-10px_rgba(198,167,92,0.15)]" : ""}
              `}
              style={{
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(rgba(198,167,92,1) 1px, transparent 1px), linear-gradient(90deg, rgba(198,167,92,1) 1px, transparent 1px)",
                  backgroundSize: "40px 40px",
                }}
              />

              <div className="relative z-10 p-6 sm:p-8 flex flex-col sm:flex-row gap-5 sm:gap-8">
                {/* Esquerda: índice + nome */}
                <div className="shrink-0 sm:w-44">
                  <div className="flex items-center gap-2 mb-3">
                    <div
                      className={`w-1.5 h-1.5 rounded-full ${camada.dotColor} transition-all duration-300 ${ativa === i ? "scale-150" : ""}`}
                    />
                    <span className="text-[9px] text-muted-foreground/40 tracking-[0.3em] uppercase">
                      {camada.index} — {camada.rotulo}
                    </span>
                  </div>
                ...
                <div className="flex-1 sm:border-l border-white/5 sm:pl-8">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {camada.badges.map((b, j) => (
                      <span
                        key={j}
                        className="text-[8px] tracking-widest uppercase bg-primary/5 border border-primary/10 text-primary/60 px-2.5 py-1"
                      >
                        {b}
                      </span>
                    ))}
      ...
      >
        ...
        <span className="text-[9px] text-muted-foreground/30 tracking-[0.3em] uppercase">
          Corretoras EUA · Execução Instantânea
        </span>
